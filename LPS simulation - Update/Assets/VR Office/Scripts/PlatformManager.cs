...
namespace ChiliGames.VROffice
{
    ...
    public class PlatformManager : MonoBehaviourPunCallbacks
    {
        ...
        private void Start()
        {
            ...
            //if this is the Master, activate its rig and create the body
            if (mode == Mode.VR)
            {
            ...
            //if it's a Player, create it's body and sit in right position if the student list already exists
        ...
        //This is called when a player leaves the room, so we can free the player's place
        public override void OnPlayerLeftRoom(Player otherPlayer)
        {
            //get the seat number of player that left the room, and update room properties with the free seat (value to 0)
