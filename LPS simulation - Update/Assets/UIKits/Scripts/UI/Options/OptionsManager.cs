...
namespace VRUiKits.Utils
{
    public class OptionsManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (isAvatarOption)
            {
                PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(MultiplayerVRConstants.AVATAR_SELECTION_NUMBER, out storedAvatarSelectionNumber);//add for sychonise the options
                firstSelectedIndex = (int)storedAvatarSelectionNumber;//add for sychonise the options
