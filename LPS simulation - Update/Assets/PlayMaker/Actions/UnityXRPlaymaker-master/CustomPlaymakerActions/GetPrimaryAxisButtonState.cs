...
namespace DGD
{
    ...
    [Tooltip("Get Primary Axis Button Pressed State. True for pressed, false for not pressed.")]
    public class GetPrimaryAxisButtonState : FsmStateAction
    {
        [RequiredField]
        ...
        public FsmBool primaryAxisButtonState;
        ...
        void GetValue()
        {
            ...
            primaryAxisButtonState.Value = input.primary2DAxisButton;
        }
    }
}